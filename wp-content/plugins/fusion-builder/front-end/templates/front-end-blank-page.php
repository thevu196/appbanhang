	...
	<div class="fusion-builder-blank-page-content fusion-builder-data-cid" data-cid="{{ cid }}">
		...
		<#
			var additionalClassNames = FusionApp.data.template_category && 'header' === FusionApp.data.template_category ? 'prebuilt-headers' : '',
				btnLabel			 = additionalClassNames ? 'pre_built_header' : 'pre_built_page';
		#>
		<# if ( 'fusion_tb_section' !== FusionApp.data.postDetails.post_type || additionalClassNames || ( FusionApp.data.template_override.content && FusionApp.data.postDetails.post_id === FusionApp.data.template_override.content.ID ) ) { #>
