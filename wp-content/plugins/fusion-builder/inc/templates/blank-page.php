...
<script type="text/template" id="fusion-builder-blank-page-template">
	<div class="fusion-builder-blank-page-content fusion-builder-data-cid" data-cid="{{ cid }}">
		...
		<?php if ( 'fusion_tb_section' !== get_post_type() || Fusion_Template_Builder()->is_template( 'header' ) || 'content' === wp_get_post_terms( get_the_ID(), 'fusion_tb_category' )[0]->slug ) : ?>
			<# var btnLabel = '<?php echo Fusion_Template_Builder()->is_template( 'header' ) ? 'pre_built_header' : 'pre_built_page'; ?>'; #>
